...
def _parse_args():
    ...
    parser.add_argument('--no_java_eval', dest='perform_java_eval', default=False, action='store_false', help='run evaluation of constructed query against java backend')
    ...
    parser.add_argument('--eval_from_checkpoint', default=True, action='store_true', help="Evaluate model from checkpoint")
